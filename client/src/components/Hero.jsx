...
const Hero = () => {
  return (
    ...
    >
      ...
      <h1 className="font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-14 font-bold mt-4 md:font-extrabold max-w-xl">
      ...
      <form className="bg-white text-gray-500 rounded-lg px-6 py-4  flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto mt-9.5">
        <div>
